      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {cuponsFiltrados.map((cupom) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1 italic">Desconto: R$ {cupom.valorDesconto.toFixed(2)}</p>
            <p className="text-sm text-gray-500">Início: {cupom.dataInicio}</p>
            <p className="text-sm text-gray-500">Vencimento: {cupom.dataVencimento}</p>
